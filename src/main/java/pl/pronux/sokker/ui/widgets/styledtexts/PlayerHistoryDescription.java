...
public class PlayerHistoryDescription extends StyledText implements IDescription {
	...
	private void fill(Player player, int index, boolean atTraining) {
		...
		addSkill(Messages.getString("player.stamina"), Messages.getString("skill.b" + player.getSkills()[max].getStamina()), player.getSkills()[max].getStamina(), player.getSkills()[0].getStamina(), getText().length());  

		addSkill(Messages.getString("player.keeper"), Messages.getString("skill.a" + player.getSkills()[max].getKeeper()), player.getSkills()[max].getKeeper(), player.getSkills()[0].getKeeper(), getText().length());  

		this.addText(NEW_LINE);

		addSkill(Messages.getString("player.pace"), Messages.getString("skill.b" + player.getSkills()[max].getPace()), player.getSkills()[max].getPace(), player.getSkills()[0].getPace(), getText().length());  

		addSkill(Messages.getString("player.defender"), Messages.getString("skill.a" + player.getSkills()[max].getDefender()), player.getSkills()[max].getDefender(), player.getSkills()[0].getDefender(), getText().length());  

		this.addText(NEW_LINE);

		addSkill(Messages.getString("player.technique"), Messages.getString("skill.b" + player.getSkills()[max].getTechnique()), player.getSkills()[max].getTechnique(), player.getSkills()[0].getTechnique(), getText().length());  

		addSkill(Messages.getString("player.playmaker"), Messages.getString("skill.a" + player.getSkills()[max].getPlaymaker()), player.getSkills()[max].getPlaymaker(), player.getSkills()[0].getPlaymaker(), getText().length());  

		this.addText(NEW_LINE);

		addSkill(Messages.getString("player.passing"), Messages.getString("skill.c" + player.getSkills()[max].getPassing()), player.getSkills()[max].getPassing(), player.getSkills()[0].getPassing(), getText().length());  

		addSkill(Messages.getString("player.scorer"), Messages.getString("skill.a" + player.getSkills()[max].getScorer()), player.getSkills()[max].getScorer(), player.getSkills()[0].getScorer(), getText().length());  
